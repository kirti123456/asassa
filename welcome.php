...
<body>
	...
	<div style="width:20%;height:100%;">
		<img src="img/g.jpg" width="100px" height="100px" style="border-radius:50%;margin-left:10px;margin-top:20px"/><a href="#"><h3 style="margin-left:20px;color:blue; font-family:calibri;text-decoration: none;">Jhon Mack</h3></a>	
	</div>
